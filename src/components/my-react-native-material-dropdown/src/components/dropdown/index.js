...
export default class Dropdown extends PureComponent {
  ...
  static propTypes = {
    ...
    triangleImage: PropTypes.any,
    rippleMarginTop : PropTypes.number, 
    rippleMarginLeft: PropTypes.number, 
  ...
  renderRipple() {
    ...
    let style = {
      ...
      position: 'absolute',
      marginTop: rippleMarginTop,
      marginLeft: rippleMarginLeft
    };
    if(typeof rippleWidth != 'undefined'){
      style.width = rippleWidth;
    }
    if(typeof rippleHeight != 'undefined'){
      style.width = rippleHeight;
    }
    return (
      <Ripple
        style={style}
  ...
  renderAccessory() {
    ...
    let { triangleImage,baseColor:backgroundColor } = this.props;
    ...
    return (
      <View style={styles.accessory}>
        <View style={styles.triangleContainer}>
          <Image style={[styles.triangle]} source={triangleImage}/>
        </View>
      </View>
    );
  }
